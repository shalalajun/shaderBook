...
import fragmentShaderHead from '../shaders/fragmentShaderHead.frag'
import fragmentShaderBody from '../shaders/fragmentShaderBody.frag'
/**
 * Base
 */
// Debug
...
const headMaterial = new THREE.ShaderMaterial(
    {
        ...
        uniforms:{ 
            ...
            uColor: {value: new THREE.Color('#ffffff')},
            uGlossiness: { value: 1 },
            uHeadTex: { value: catHead },
            uShadowColor: { value: shadowColor }
        },
        vertexShader: vertexShader,
        fragmentShader: fragmentShaderHead
    }
    )
...
const bodyMaterial = new THREE.ShaderMaterial(
    {
        ...
        uniforms:{ 
            ...
            uColor: {value: new THREE.Color('#ffffff')},
            uGlossiness: { value: 1 },
            uBodyTex: { value: catBody },
            uShadowColor: { value: shadowColor }
        },
        vertexShader: vertexShader,
        fragmentShader: fragmentShaderBody
    }
    )
